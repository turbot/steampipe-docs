...
<table>
  ...
  <tr> 
    ...
    <td>  Select the console <a href="#output-formats">output format</a>.  Defaults to <inlineCode>text</inlineCode>. Possible values are <inlineCode>brief,csv,html,json,md,text,none</inlineCode></td> 
  </tr>

  <tr> 
    <td nowrap="true"> <inlineCode>--progress</inlineCode>  </td> 
    <td> Enable or disable the progress bar. By default, the progress bar is shown - set <inlineCode>--progress=false</inlineCode> to hide the progress bar.  </td>
  </tr>
  <tr> 
